                                  ...
                                  children: [
                                    ...
                                    Visibility(
                                      ...
                                      child: PopupMenuButton<String>(
                                            ...
                                            final chatHistory = model.messages.map((message) {
                                                  ...
                                                  Clipboard.setData(ClipboardData(text: chatHistory));
                                                      ...
                                                      case AIChatPopupMenuActions.SHARE_CHAT:
                                                       Share.share(chatHistory, subject:'');
                                                      break;
                                          ...
                                          // }
                                                 showMessage('All Message Deleted');
                                                      break;
                                                     }
                                              },
                                              offset: Offset(0, 47),
                                              ...
                                              itemBuilder: (popupMenuContext) {
                                                ...
                                                items.addAll(AIChatPopupMenuActions.choices.map((choice) {
                                                  switch (choice) {
                                                    case AIChatPopupMenuActions.COPY_CHAT:
                                                      return CustomPopupMenuItem<String>(
                                                        enabled: model.messages.isNotEmpty && !model.isTyping && isNotRetry,
                                                        value: choice,
                                                        height: 35,
                                                        child: Row(
                                                            children: [
                                                             SvgPicture.asset(IconConstants.copyIconWhite ,color:model.messages.isEmpty ||  model.isTyping || !isNotRetry ? themeProvider.darkTheme ? Color(0xff6D6D81): Color(0xffC5C5C5) : themeProvider.darkTheme
                                                  ...
                                                  .textTheme
                                                  .bodySmall?.copyWith( 
                                                    color: model.messages.isEmpty || model.isTyping || !isNotRetry ? themeProvider.darkTheme ? Color(0xff6D6D81): Color(0xffC5C5C5) : themeProvider.darkTheme ? Colors.white:Colors.black
                                                  )),
                                                              ),
                                                            ]),
                                                      );
                                                    case AIChatPopupMenuActions.SHARE_CHAT:
                                                      return CustomPopupMenuItem<String>(
                                                        ...
                                                        child: Row(
                                                            children: [
                                                               SvgPicture.asset('assets/images/ai-icons/Share.svg' ,color:model.messages.isEmpty || model.isTyping  || !isNotRetry ? themeProvider.darkTheme ? Color(0xff6D6D81): Color(0xffC5C5C5) : themeProvider.darkTheme
                                                  ?const Color(0xffFFFFFF)
                                                  :const Color(0xff282836)),
                                                              Padding(
                               ...
                               return AnimatedOpacity(
                                ...
                                child: Visibility(
                                  visible: (model.canshowWelcome &&
                                      ...
                                      model.isSummariseAvailable) && !isKeyboardVisible && !vpnStatusProvider.showErrorPage,
                                  child: Container(
                                      height:
