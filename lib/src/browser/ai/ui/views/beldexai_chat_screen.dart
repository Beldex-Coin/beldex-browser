...
checkSummariseString(WebViewModel webViewModel,ChatViewModel model){
  if(webViewModel != null && webViewModel.url != null){
     if(webViewModel.url!.scheme =='http' || webViewModel.url!.scheme =='https'){
      // Regex to match common search engine result page patterns
    final searchEnginePattern = RegExp(
      r'(\?|&)q=|search=|(\?|&)query=',
      caseSensitive: false,
    );
    model.isSummariseAvailable = !searchEnginePattern.hasMatch(webViewModel.url.toString());
    //setState(() {
                    ...
                    return Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          model.canshowWelcome  ? InitialSummariseWelcomeWidget(themeProvider: themeProvider,):SizedBox(),
                         // Spacer(),
                          model.canshowWelcome && browserModel.webViewTabs.isNotEmpty && model.isSummariseAvailable ? Container(
                              ...
                              children: [
                               ...
                               //setState(() {
                                  model.canshowWelcome = false;
                                    // });
                                     model.isSummariseAvailable = false;
                                    model.summariseText = webViewModel.url.toString() ?? '';
                                    model.getTextAndSummariseInfo(webViewModel);
                            ...
                            browserModel.webViewTabs.isNotEmpty && model.isSummariseAvailable  && model.canshowWelcome == false ? Row(
