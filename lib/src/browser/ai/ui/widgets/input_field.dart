...
import 'package:beldex_browser/src/browser/ai/ui/widgets/common_input_field_buttons.dart';
import 'package:beldex_browser/src/browser/ai/ui/widgets/common_text_form_field.dart';
                    ...
                    widget.model?.imageFile != null
                        ? Container(
                            ...
                            child: Image(
                              height: 200,
                              width: 200,
                              image: FileImage(widget.model?.imageFile ??
                                  File(ImageConstants.demo)),
                            ),
                          )
                        : const SizedBox(),
                    Row(
                        ...
                        InputFieldButton(
                          ...
                          onpressed: () {
                            if (widget.model?.imageFile != null &&
                                widget.model!.messageController.text
                                    .toString()
                                    .isEmpty) {
                              widget.model?.getTextAndImageInfo();
                            }
                            if (widget.model?.messageController.text
                                    .toString()
                                    .isNotEmpty ??
                                false) {
                              widget.model?.getTextAndImageInfo();
