        ...
        child:themeProvider.darkTheme ? Image.asset(
          ...
          fit: BoxFit.cover,
                  ...
                  Column(
                    children: [
                      GlassSettingPanel(
                        color:themeProvider.darkTheme ? Color(0xff222222).withOpacity(0.7) : Color(0xffFFFFFF).withOpacity(0.1),
                        child: Container(
                          child:
                                             ...
                                             Container(
                                              ...
                                              height: 45,
                                               child: VerticalDivider(
                                                                         ...
                                                                         endIndent: 10,
                                                                         thickness: 1.5,
                                                                         color: themeProvider.darkTheme ? Color(0xff444444) : Color(0xffDADADA),
                                                                       ),
                                             ),
                                              menuOptions(
                              ...
                              Column(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                //       color:themeProvider.darkTheme ? Color(0xff0B0B0B)
                                // : Color(0xffFFFFFF),
